...
from .forms import BlogPostForm  # You need to create a form for this model
...
def post_blog(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            # Set the author, timestamp, and post_date before saving the form
            form.instance.author = request.user
            form.instance.post_date = timezone.now()  # Import timezone at the top of your views.py
            form.save()
